...
*
* \funcusage
*  \snippet RTD_4_0_SUT.c usage_RTD_4_0_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet RTD_4_0_SUT.c usage_RTD_4_0_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet RTD_4_0_SUT.c usage_RTD_4_0_Read  
*******************************************************************************/
...
* preferred RTD_4_0_Read() API because the 
* RTD_4_0_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet RTD_4_0_SUT.c usage_RTD_4_0_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: RTD_4_0_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use RTD_4_0_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - RTD_4_0_0_INTR       (First pin in the list)
    *  - RTD_4_0_1_INTR       (Second pin in the list)
    *  - ...
    *  - RTD_4_0_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet RTD_4_0_SUT.c usage_RTD_4_0_SetInterruptMode
    *******************************************************************************/
    void RTD_4_0_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & RTD_4_0_0_INTR) != 0u) 
		{ 
			 RTD_4_0_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet RTD_4_0_SUT.c usage_RTD_4_0_ClearInterrupt
    *******************************************************************************/
