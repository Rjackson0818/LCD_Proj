// ======================================================================
// LCD_RTD_exercise.v generated from TopDesign.cysch
// 12/29/2018 at 08:11
...
// IDAC8_v2_0(Current=1000, Data_Source=0, Hardware_Enable=false, IDAC_Range=8, IDAC_Speed=2, Initial_Value=125, Polarity=0, Strobe_Mode=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=IDAC8_v2_0, CY_CONFIG_TITLE=IDAC, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC, CY_INSTANCE_SHORT_NAME=IDAC, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=IDAC, )
module IDAC8_v2_0_0 (
    strobe,
    data,
    iOut,
...
module ADC_DelSig_v3_30_1 (
	...
	cy_clock_v1_0
		#(.id("25d69c3e-b23b-4334-ba46-32e6e1ed0a0d/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("25d69c3e-b23b-4334-ba46-32e6e1ed0a0d/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
module CharLCD_v2_20_3 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("0611febc-6c91-47be-9275-6fc320bd98f5/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    IDAC8_v2_0_0 IDAC (
        ...
        .en(1'b0),
        .ipolarity(1'b0));
    defparam IDAC.Data_Source = 0;
    defparam IDAC.Initial_Value = 125;
    defparam IDAC.Strobe_Mode = 0;
    ...
    cy_psoc3_amux_v1_0 ADCMux_CYAMUXSIDE_A(
        .muxin({
            Net_14,
            Net_39
            }),
    ...
    defparam ADCMux_CYAMUXSIDE_A.muxin_width = 2;
    defparam ADCMux_CYAMUXSIDE_A.init_mux_sel = 2'h0;
    defparam ADCMux_CYAMUXSIDE_A.one_active = 0;
    defparam ADCMux_CYAMUXSIDE_A.connect_mode = 1;
    
    
    // -- Mux B --
    
    cy_psoc3_amux_v1_0 ADCMux_CYAMUXSIDE_B(
        .muxin({
            Net_42,
            Net_33
            }),
    ...
    defparam ADCMux_CYAMUXSIDE_B.muxin_width = 2;
    defparam ADCMux_CYAMUXSIDE_B.init_mux_sel = 2'h0;
    defparam ADCMux_CYAMUXSIDE_B.one_active = 0;
    defparam ADCMux_CYAMUXSIDE_B.connect_mode = 1;
    
    // -- AMux ADCMux end --

    // -- AMux CurrentMux start -- ***
    // -- Mux A --
    
    cy_psoc3_amux_v1_0 CurrentMux(
        .muxin({
            Net_29,
            Net_37
            }),
    ...
    defparam CurrentMux.muxin_width = 2;
    defparam CurrentMux.init_mux_sel = 2'h0;
    defparam CurrentMux.one_active = 0;
    defparam CurrentMux.connect_mode = 1;
    
    // -- AMux CurrentMux end --

	wire [0:0] tmpOE__RTD_3_1_net;
	wire [0:0] tmpFB_0__RTD_3_1_net;
	wire [0:0] tmpIO_0__RTD_3_1_net;
	wire [0:0] tmpINTERRUPT_0__RTD_3_1_net;
	electrical [0:0] tmpSIOVREF__RTD_3_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		RTD_3_1
		 (.oe(tmpOE__RTD_3_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RTD_3_1_net[0:0]}),
		  .analog({Net_37}),
		  .io({tmpIO_0__RTD_3_1_net[0:0]}),
		  .siovref(tmpSIOVREF__RTD_3_1_net),
		  .interrupt({tmpINTERRUPT_0__RTD_3_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RTD_3_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Calib_3_4_net;
	wire [0:0] tmpFB_0__Calib_3_4_net;
	wire [0:0] tmpIO_0__Calib_3_4_net;
	wire [0:0] tmpINTERRUPT_0__Calib_3_4_net;
	electrical [0:0] tmpSIOVREF__Calib_3_4_net;

	cy_psoc3_pins_v1_10
		#(.id("8578d397-e702-4f72-9a66-17b7a11ee4c5"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Calib_3_4
		 (.oe(tmpOE__Calib_3_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Calib_3_4_net[0:0]}),
		  .analog({Net_29}),
		  .io({tmpIO_0__Calib_3_4_net[0:0]}),
		  .siovref(tmpSIOVREF__Calib_3_4_net),
		  .interrupt({tmpINTERRUPT_0__Calib_3_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Calib_3_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RTD_4_0_net;
	wire [0:0] tmpFB_0__RTD_4_0_net;
	wire [0:0] tmpIO_0__RTD_4_0_net;
	wire [0:0] tmpINTERRUPT_0__RTD_4_0_net;
	electrical [0:0] tmpSIOVREF__RTD_4_0_net;

	cy_psoc3_pins_v1_10
		#(.id("e9a4537c-e3e8-428b-a5b6-681bd6b3037c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RTD_4_0
		 (.oe(tmpOE__RTD_4_0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RTD_4_0_net[0:0]}),
		  .analog({Net_39}),
		  .io({tmpIO_0__RTD_4_0_net[0:0]}),
		  .siovref(tmpSIOVREF__RTD_4_0_net),
		  .interrupt({tmpINTERRUPT_0__RTD_4_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RTD_4_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RTD_4_1_net;
	wire [0:0] tmpFB_0__RTD_4_1_net;
	wire [0:0] tmpIO_0__RTD_4_1_net;
	wire [0:0] tmpINTERRUPT_0__RTD_4_1_net;
	electrical [0:0] tmpSIOVREF__RTD_4_1_net;

	cy_psoc3_pins_v1_10
		#(.id("18fd9d15-f3f5-4715-b88d-0dc1b41360a1"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RTD_4_1
		 (.oe(tmpOE__RTD_4_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RTD_4_1_net[0:0]}),
		  .analog({Net_33}),
		  .io({tmpIO_0__RTD_4_1_net[0:0]}),
		  .siovref(tmpSIOVREF__RTD_4_1_net),
		  .interrupt({tmpINTERRUPT_0__RTD_4_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RTD_4_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Calib_4_4_net;
	wire [0:0] tmpFB_0__Calib_4_4_net;
	wire [0:0] tmpIO_0__Calib_4_4_net;
	wire [0:0] tmpINTERRUPT_0__Calib_4_4_net;
	electrical [0:0] tmpSIOVREF__Calib_4_4_net;

	cy_psoc3_pins_v1_10
		#(.id("d26b6a17-91b4-4f01-b612-4c915dea4c2c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Calib_4_4
		 (.oe(tmpOE__Calib_4_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Calib_4_4_net[0:0]}),
		  .analog({Net_14}),
		  .io({tmpIO_0__Calib_4_4_net[0:0]}),
		  .siovref(tmpSIOVREF__Calib_4_4_net),
		  .interrupt({tmpINTERRUPT_0__Calib_4_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Calib_4_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Calib_4_5_net;
	wire [0:0] tmpFB_0__Calib_4_5_net;
	wire [0:0] tmpIO_0__Calib_4_5_net;
	wire [0:0] tmpINTERRUPT_0__Calib_4_5_net;
	electrical [0:0] tmpSIOVREF__Calib_4_5_net;

	cy_psoc3_pins_v1_10
		#(.id("7e6080cb-65b4-4eed-a934-c362f472cd02"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Calib_4_5
		 (.oe(tmpOE__Calib_4_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Calib_4_5_net[0:0]}),
		  .analog({Net_42}),
		  .io({tmpIO_0__Calib_4_5_net[0:0]}),
		  .siovref(tmpSIOVREF__Calib_4_5_net),
		  .interrupt({tmpINTERRUPT_0__Calib_4_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Calib_4_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
