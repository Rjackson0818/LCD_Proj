...
*
* \funcusage
*  \snippet Calib_4_5_SUT.c usage_Calib_4_5_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Calib_4_5_SUT.c usage_Calib_4_5_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Calib_4_5_SUT.c usage_Calib_4_5_Read  
*******************************************************************************/
...
* preferred Calib_4_5_Read() API because the 
* Calib_4_5_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Calib_4_5_SUT.c usage_Calib_4_5_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Calib_4_5_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Calib_4_5_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Calib_4_5_0_INTR       (First pin in the list)
    *  - Calib_4_5_1_INTR       (Second pin in the list)
    *  - ...
    *  - Calib_4_5_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Calib_4_5_SUT.c usage_Calib_4_5_SetInterruptMode
    *******************************************************************************/
    void Calib_4_5_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Calib_4_5_0_INTR) != 0u) 
		{ 
			 Calib_4_5_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Calib_4_5_SUT.c usage_Calib_4_5_ClearInterrupt
    *******************************************************************************/
