...
*
* \funcusage
*  \snippet Calib_3_4_SUT.c usage_Calib_3_4_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Calib_3_4_SUT.c usage_Calib_3_4_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Calib_3_4_SUT.c usage_Calib_3_4_Read  
*******************************************************************************/
...
* preferred Calib_3_4_Read() API because the 
* Calib_3_4_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Calib_3_4_SUT.c usage_Calib_3_4_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Calib_3_4_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Calib_3_4_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Calib_3_4_0_INTR       (First pin in the list)
    *  - Calib_3_4_1_INTR       (Second pin in the list)
    *  - ...
    *  - Calib_3_4_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Calib_3_4_SUT.c usage_Calib_3_4_SetInterruptMode
    *******************************************************************************/
    void Calib_3_4_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Calib_3_4_0_INTR) != 0u) 
		{ 
			 Calib_3_4_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Calib_3_4_SUT.c usage_Calib_3_4_ClearInterrupt
    *******************************************************************************/
