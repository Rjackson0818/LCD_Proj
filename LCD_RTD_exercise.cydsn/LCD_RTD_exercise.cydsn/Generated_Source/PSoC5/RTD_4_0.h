...
*/
     ...
     *  @{
     */
        #define RTD_4_0_INTR_NONE      (uint16)(0x0000u)
        #define RTD_4_0_INTR_RISING    (uint16)(0x0001u)
        #define RTD_4_0_INTR_FALLING   (uint16)(0x0002u)
        #define RTD_4_0_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define RTD_4_0_INTR_MASK      (0x01u) 
#endif /* (RTD_4_0__INTSTAT) */
...
/* SIO registers */
#if defined(RTD_4_0__SIO_CFG)
    #define RTD_4_0_SIO_HYST_EN        (* (reg8 *) RTD_4_0__SIO_HYST_EN)
    #define RTD_4_0_SIO_REG_HIFREQ     (* (reg8 *) RTD_4_0__SIO_REG_HIFREQ)
    #define RTD_4_0_SIO_CFG            (* (reg8 *) RTD_4_0__SIO_CFG)
    #define RTD_4_0_SIO_DIFF           (* (reg8 *) RTD_4_0__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define RTD_4_0_0_INTTYPE_REG 		(* (reg8 *) RTD_4_0__0__INTTYPE)
#endif /* (RTD_4_0__INTSTAT) */
