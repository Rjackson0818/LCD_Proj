...
*/
     ...
     *  @{
     */
        #define Calib_3_4_INTR_NONE      (uint16)(0x0000u)
        #define Calib_3_4_INTR_RISING    (uint16)(0x0001u)
        #define Calib_3_4_INTR_FALLING   (uint16)(0x0002u)
        #define Calib_3_4_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Calib_3_4_INTR_MASK      (0x01u) 
#endif /* (Calib_3_4__INTSTAT) */
...
/* SIO registers */
#if defined(Calib_3_4__SIO_CFG)
    #define Calib_3_4_SIO_HYST_EN        (* (reg8 *) Calib_3_4__SIO_HYST_EN)
    #define Calib_3_4_SIO_REG_HIFREQ     (* (reg8 *) Calib_3_4__SIO_REG_HIFREQ)
    #define Calib_3_4_SIO_CFG            (* (reg8 *) Calib_3_4__SIO_CFG)
    #define Calib_3_4_SIO_DIFF           (* (reg8 *) Calib_3_4__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define Calib_3_4_0_INTTYPE_REG 		(* (reg8 *) Calib_3_4__0__INTTYPE)
#endif /* (Calib_3_4__INTSTAT) */
